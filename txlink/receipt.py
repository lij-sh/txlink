...
def cust_list():
    ...
    if request.method == 'GET':
        ...
        return render_template('cust/customer/cust_list.html', custs=custs)
    ...
    if request.method == 'POST':
        ...
        if error is None:
            try:
                ...
                return redirect(url_for("warehouse.cust_list"))
        flash(error)

    return render_template('cust/customer/add_cust.html')
...
def edit_cust(id):
    ...
    return render_template('cust/customer/edit_cust.html', cust=cust)